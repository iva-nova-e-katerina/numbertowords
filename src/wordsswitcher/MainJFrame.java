...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private static TranliterationFacade engine;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Long inputNumber;
        try {
            inputNumber = new Long(jTextField1.getText());
        } catch (NumberFormatException ex){
            jLabel1.setText("not a number");
            return;
        }
    
        
        String text = engine.transliterate(inputNumber);
    ...
    public static void main(String args[]) {
        ...
        invokeLater(() -> {
            ...
            engine = new EnglishTranslitirationImpl(new Locale("en", "US"));
        });
